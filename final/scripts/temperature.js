...
const myLat = "16.422583"
const myLong = "120.624083"


const myUrl = `https://api.openweathermap.org/data/2.5/weather?lat=${myLat}&lon=${myLong}&appid=${myKeys}&units=metric`
const myForcastUrl = `https://api.openweathermap.org/data/2.5/forecast?lat=${myLat}&lon=${myLong}&appid=${myKeys}&units=metric`
...
function displayForecast(data) {
    ...
    // Temperatures
    day1Temp.innerHTML =
        `${Math.round(day1.main.temp)}&deg;C`;

    day2Temp.innerHTML =
        `${Math.round(day2.main.temp)}&deg;C`;

    day3Temp.innerHTML =
        `${Math.round(day3.main.temp)}&deg;C`;
}
